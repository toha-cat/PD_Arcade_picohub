...
#define ARCADE_LED_BTN1 2  // BUTTON LED TRIANGLE
#define ARCADE_LED_BTN2 3  // BUTTON LED SQUARE
#define ARCADE_LED_BTN3 4  // BUTTON LED CROSS
#define ARCADE_LED_BTN4 5  // BUTTON LED CIRCLE
#define ARCADE_LED_R1 6  // LEFT PARTITION LED RED
#define ARCADE_LED_G1 7  // LEFT PARTITION LED GREEN
#define ARCADE_LED_B1 8  // LEFT PARTITION LED BLUE
#define ARCADE_LED_R2 9  // RIGHT PARTITION LED RED
#define ARCADE_LED_G2 10 // RIGHT PARTITION LED GREEN
#define ARCADE_LED_B2 11 // RIGHT PARTITION LED BLUE
